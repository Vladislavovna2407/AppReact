...
export const PublicNotes = () => {
  const { translations } = useLocalization()
    let publicList = [
        { id: 1, title: 'newTitle1', text: 'newText1', tags: ['newTag1'], owner: 'Ira', color: 'pink', isPublic: true },
        { id: 2, title: 'newTitle2', text: 'newText2', tags: ['newTag2'], owner: 'Ira', color: 'grey', isPublic: true }
    ]
